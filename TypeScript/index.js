...
var BankAccountManager = /** @class */ (function () {
    function BankAccountManager() {
        this.accounts = [];
    }
    BankAccountManager.prototype.createAccount = function (account) {
        this.accounts.push(account);
    };
    BankAccountManager.prototype.closeAccount = function (accountNumber) {
        this.accounts = this.accounts.filter(function (account) { return account.accountNumber !== accountNumber; });
    };
    BankAccountManager.prototype.getAccountByNumber = function (accountNumber) {
        return this.accounts.find(function (account) { return account.accountNumber === accountNumber; });
    };
    BankAccountManager.prototype.listAllAccounts = function () {
        return this.accounts;
    };
    BankAccountManager.prototype.deposit = function (accountNumber, amount) {
        {
            var account = this.getAccountByNumber(accountNumber);
            if (account) {
                account.balance = account.balance + amount;
            }
            else {
                throw new Error("Account with number ".concat(accountNumber, " not found"));
            }
        }
    };
    BankAccountManager.prototype.withdraw = function (accountNumber, amount) {
        var account = this.getAccountByNumber(accountNumber);
        if (account) {
    ...
    BankAccountManager.prototype.getAccountHolderAndBalance = function (accountNumber) {
        var account = this.getAccountByNumber(accountNumber);
        if (account) {
            return {
    ...
    BankAccountManager.prototype.getAccountWithoutBalance = function (accountNumber) {
        var account = this.getAccountByNumber(accountNumber);
        if (account) {
            return {
    ...
    BankAccountManager.prototype.updateAccount = function (accountNumber, updatedInfo) {
        var account = this.getAccountByNumber(accountNumber);
        if (account) {
            var index = this.accounts.findIndex(function (acc) { return acc.accountNumber === accountNumber; });
            this.accounts[index] = __assign(__assign({}, account), updatedInfo);
        }
        else {
            throw new Error("Account with number ".concat(accountNumber, " not found"));
        }
...
var account1 = new BankAccount(1, 'Lê Văn A', 500);
var account2 = new BankAccount(2, 'Lung Thị Linh', 300);
...
var allAccounts = manager.listAllAccounts();
console.log(manager);
